...
const SentimentSummaryBar = ({ summary, title }) => {
  ...
  return (
    <div className="rounded-xl border border-border bg-card backdrop-blur-md px-4 py-4 shadow-lg">
      ...
      {/* Bar Chart */}
      <div className="w-full h-3 rounded-full overflow-hidden flex bg-muted mb-3">
        {/* Positive */}
      ...
      <div className="grid grid-cols-3 gap-2 text-[11px]">
        ...
        <div className="flex items-center space-x-1.5">
          ...
          <div className="flex flex-col min-w-0">
            <span className="text-muted-foreground text-[10px]">Positive</span>
            <span className="text-card-foreground font-semibold">{summary.positive}</span>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-1.5">
          ...
          <div className="flex flex-col min-w-0">
            ...
            <span className="text-card-foreground font-semibold">{summary.neutral}</span>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-1.5">
          ...
          <div className="flex flex-col min-w-0">
            <span className="text-muted-foreground text-[10px]">Negative</span>
            <span className="text-card-foreground font-semibold">{summary.negative}</span>
          </div>
        </div>
      </div>
      ...
      <div className="mt-3 pt-3 border-t border-border">
        <div className="flex items-center justify-between">
          <span className="text-[10px] text-muted-foreground uppercase">Dominant Tone:</span>
