...
export default function CommunityLayout({ children }) {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-slate-950 to-slate-900" style={{ marginTop: '56px' }}>
      {/* Header */}
      <header className="sticky top-[56px] z-40 bg-slate-950/95 backdrop-blur-sm border-b border-slate-800">
      ...
      {/* Navigation */}
      <nav className="sticky top-[129px] z-30 bg-slate-900/95 backdrop-blur-sm border-b border-slate-800">
