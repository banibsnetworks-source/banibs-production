...
const HighFiveButton = ({
  ...
  const displaySize = size > 64 ? 128 : 128;
  const spriteUrl = `${process.env.REACT_APP_BACKEND_URL}/api/static/emojis/highfive/${variant}/banibs_highfive_${variant}_strip_${displaySize}.png`;
