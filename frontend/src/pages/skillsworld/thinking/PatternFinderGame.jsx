...
import { ArrowLeft, RotateCcw, ChevronRight, Check, Sparkles } from 'lucide-react';

// Import content from JSON
import patternFinderData from '../../../data/skills_world/pattern_finder_levels.json';

/**
 * Pattern Finder - Critical Thinking Activity
 * 
 * CORE MECHANIC:
...
const LEVELS = patternFinderData.levels;
...
const PatternFinderGame = () => {
  ...
  const [completedLevels, setCompletedLevels] = useState(() => {
    try {
      const saved = localStorage.getItem('banibs_patternfinder_progress');
  ...
  useEffect(() => {
    if (isLevelComplete && !completedLevels.includes(currentLevel.id)) {
      ...
      try {
        localStorage.setItem('banibs_patternfinder_progress', JSON.stringify(newCompleted));
      } catch {
        // Silent fail
      }
    }
      ...
      >
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            >
              {patternFinderData.age_guide} • Level {currentLevel.id}
            </p>
          </div>
      ...
      >
        ...
        <div className="w-full max-w-md mb-6">
          <div className="flex justify-between text-xs mb-2" style={{ color: isDark ? 'rgb(107, 114, 128)' : 'rgb(156, 163, 175)' }}>
            <span>Pattern {currentItemIndex + 1} of {totalItemsInLevel}</span>
        ...
        {isLevelComplete ? (
          ...
          >
            ...
            <p 
              ...
              style={{ color: isDark ? 'rgb(156, 163, 175)' : 'rgb(107, 114, 128)' }}
            >
              You found all the patterns in {currentLevel.name}
            </p>
          ...
          <>
            ...
            <div 
              ...
              style={{ 
                ...
                border: `2px solid ${isDark ? 'rgba(251, 191, 36, 0.2)' : 'rgba(251, 191, 36, 0.15)'}`
              }}
            >
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 mb-4">
                {currentItem.sequence.map((item, idx) => (
                  <span 
                    key={idx}
            ...
            <div className="min-h-[60px] mb-4 text-center">
              {isCorrect === true && (
                ...
                >
                  <Check size={18} />
                  <span className="font-medium">You found the pattern!</span>
                </div>
              )}
              {isCorrect === false && (
                <div 
