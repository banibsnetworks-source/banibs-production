  ...
  const activities = [
    {
      ...
      description: 'Discover patterns and predict what comes next. Train your eye to see connections.',
      ageGuide: 'Ages 5-9+',
      path: '/skillsworld/thinking/pattern-finder',
      status: 'active',
      difficulty: 'Beginner',
    ...
    },
    {
      id: 'logic-puzzles',
      title: 'Logic Puzzles',
      description: 'Think carefully and solve puzzles step by step. Use clues to find answers.',
      ageGuide: 'Ages 6-10+',
      path: '/skillsworld/thinking/logic-puzzles',
      status: 'active',
      difficulty: 'Beginner',
    ...
    },
    {
      id: 'cause-effect',
      title: 'Cause & Effect',
      description: 'Understand why things happen and what happens next. See how actions connect.',
      ageGuide: 'Ages 5-9+',
      path: '/skillsworld/thinking/cause-effect',
      status: 'active',
      difficulty: 'Beginner',
    ...
    >
          ...
          {activities.map((activity) => {
            ...
            const cardContent = (
              <div 
                ...
                onMouseEnter={(e) => {
                  if (isActive) {
                    e.currentTarget.style.borderColor = isDark ? 'rgba(251, 191, 36, 0.3)' : 'rgba(251, 191, 36, 0.3)';
      ...
      >
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          >
            Critical Thinking — Skills World
          </p>
        </div>
      </footer>
    </div>
...
export default CriticalThinkingHome;
