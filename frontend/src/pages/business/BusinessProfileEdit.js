...
const BusinessProfileEdit = () => {
  ...
  const initialTab = urlParams.get('tab') === 'verification' ? 'verification' : 'profile';
    ...
    <div className="business-edit-container">
      ...
      {activeTab === 'verification' && (
        <div className="max-w-4xl mx-auto">
          {businessId ? (
            <BusinessVerificationDashboard businessId={businessId} />
          ) : (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
              ...
              <p className="text-yellow-700 mb-4">
                You need to create and save your business profile before you can upload verification documents.
              </p>
              <button
                onClick={() => setActiveTab('profile')}
                className="bg-yellow-500 hover:bg-yellow-400 text-gray-900 font-semibold px-6 py-2 rounded-lg transition-colors"
              >
                Go to Profile Tab
              </button>
            </div>
