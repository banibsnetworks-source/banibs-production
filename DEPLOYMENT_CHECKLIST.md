...
**Test basic endpoint:**
```bash
curl https://calm-tech-learn.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://calm-tech-learn.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://calm-tech-learn.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
