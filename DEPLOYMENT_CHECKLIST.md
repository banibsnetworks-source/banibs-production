...
**Test basic endpoint:**
```bash
curl https://founder-tools-3.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://founder-tools-3.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://founder-tools-3.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
