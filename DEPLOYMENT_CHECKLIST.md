...
**Test basic endpoint:**
```bash
curl https://pay-to-promote.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://pay-to-promote.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://pay-to-promote.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
