...
**Test basic endpoint:**
```bash
curl https://cultural-pulse-2.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://cultural-pulse-2.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://cultural-pulse-2.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
