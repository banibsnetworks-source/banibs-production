...
**Test basic endpoint:**
```bash
curl https://unified-login-5.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://unified-login-5.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://unified-login-5.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
