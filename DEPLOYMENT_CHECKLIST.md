...
**Test basic endpoint:**
```bash
curl https://unified-nav.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://unified-nav.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://unified-nav.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
