...
**Test basic endpoint:**
```bash
curl https://bannersystem.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://bannersystem.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://bannersystem.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
