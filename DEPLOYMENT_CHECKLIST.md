...
**Test basic endpoint:**
```bash
curl https://emoji-migration.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://emoji-migration.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://emoji-migration.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
