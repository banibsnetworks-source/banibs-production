...
**Test basic endpoint:**
```bash
curl https://market-payments.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://market-payments.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://market-payments.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
