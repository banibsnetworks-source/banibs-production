...
**Test basic endpoint:**
```bash
curl https://themeverse-3.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://themeverse-3.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://themeverse-3.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
