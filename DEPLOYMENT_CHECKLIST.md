...
**Test basic endpoint:**
```bash
curl https://data-insights-hub-39.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://data-insights-hub-39.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://data-insights-hub-39.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
