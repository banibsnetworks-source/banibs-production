...
**Test basic endpoint:**
```bash
curl https://bookvault-manager.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://bookvault-manager.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://bookvault-manager.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
