...
**Test basic endpoint:**
```bash
curl https://frontend-update-5.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://frontend-update-5.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://frontend-update-5.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
