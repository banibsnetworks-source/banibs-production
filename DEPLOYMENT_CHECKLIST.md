...
**Test basic endpoint:**
```bash
curl https://newsaggregate-1.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://newsaggregate-1.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://newsaggregate-1.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
