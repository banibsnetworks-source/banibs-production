...
**Test basic endpoint:**
```bash
curl https://engage-biz.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://engage-biz.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://engage-biz.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
