...
**Test basic endpoint:**
```bash
curl https://api-platform-5.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://api-platform-5.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://api-platform-5.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
