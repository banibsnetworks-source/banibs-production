...
**Test basic endpoint:**
```bash
curl https://content-hub-555.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://content-hub-555.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://content-hub-555.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
