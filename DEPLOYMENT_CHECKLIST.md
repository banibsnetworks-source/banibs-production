...
**Test basic endpoint:**
```bash
curl https://a-series-preview.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://a-series-preview.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://a-series-preview.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
