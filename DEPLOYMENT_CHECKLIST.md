...
**Test basic endpoint:**
```bash
curl https://community-hub-217.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://community-hub-217.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://community-hub-217.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
