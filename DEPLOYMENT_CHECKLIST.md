...
**Test basic endpoint:**
```bash
curl https://hdos-analyze.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://hdos-analyze.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://hdos-analyze.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
