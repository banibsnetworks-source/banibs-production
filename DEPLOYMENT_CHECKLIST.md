...
**Test basic endpoint:**
```bash
curl https://banibs-launcher.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://banibs-launcher.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://banibs-launcher.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
