...
**Test basic endpoint:**
```bash
curl https://coming-soon-fix.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://coming-soon-fix.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://coming-soon-fix.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
