...
**Test basic endpoint:**
```bash
curl https://health-directory.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://health-directory.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://health-directory.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
