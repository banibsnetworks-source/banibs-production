...
**Test basic endpoint:**
```bash
curl https://infinite-circles-mvp.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://infinite-circles-mvp.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://infinite-circles-mvp.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
