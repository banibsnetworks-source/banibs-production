...
**Test basic endpoint:**
```bash
curl https://peoples-network.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://peoples-network.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://peoples-network.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
