...
**Test basic endpoint:**
```bash
curl https://banibs-news.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://banibs-news.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://banibs-news.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
