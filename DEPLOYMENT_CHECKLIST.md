...
**Test basic endpoint:**
```bash
curl https://blacknative-hub.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://blacknative-hub.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://blacknative-hub.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
