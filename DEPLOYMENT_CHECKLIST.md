...
**Test basic endpoint:**
```bash
curl https://regionsmart.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://regionsmart.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://regionsmart.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
