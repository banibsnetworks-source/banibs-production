...
**Test basic endpoint:**
```bash
curl https://community-fix-9.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://community-fix-9.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://community-fix-9.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
