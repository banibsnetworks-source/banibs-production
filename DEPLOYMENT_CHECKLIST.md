...
**Test basic endpoint:**
```bash
curl https://handsconnect.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://handsconnect.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://handsconnect.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
