...
**Test basic endpoint:**
```bash
curl https://global-network.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://global-network.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://global-network.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
