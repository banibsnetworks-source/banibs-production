...
**Test basic endpoint:**
```bash
curl https://disabilitysupport.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://disabilitysupport.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://disabilitysupport.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
