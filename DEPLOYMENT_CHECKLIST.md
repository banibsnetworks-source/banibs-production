...
**Test basic endpoint:**
```bash
curl https://chatfix-project.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://chatfix-project.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://chatfix-project.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
