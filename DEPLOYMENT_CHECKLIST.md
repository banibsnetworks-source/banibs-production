...
**Test basic endpoint:**
```bash
curl https://modal-overlay-fix-1.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://modal-overlay-fix-1.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://modal-overlay-fix-1.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
