...
**Test basic endpoint:**
```bash
curl https://peoplerooms.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://peoplerooms.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://peoplerooms.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
