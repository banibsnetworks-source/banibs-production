...
**Test basic endpoint:**
```bash
curl https://message-hub-335.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://message-hub-335.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://message-hub-335.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
