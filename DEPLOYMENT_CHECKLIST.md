...
**Test basic endpoint:**
```bash
curl https://banibsjobs.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://banibsjobs.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://banibsjobs.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
