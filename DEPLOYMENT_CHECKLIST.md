...
**Test basic endpoint:**
```bash
curl https://sms-otp-security.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://sms-otp-security.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://sms-otp-security.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
