...
**Test basic endpoint:**
```bash
curl https://currency-exchange-41.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://currency-exchange-41.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://currency-exchange-41.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
