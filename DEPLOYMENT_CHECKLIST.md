...
**Test basic endpoint:**
```bash
curl https://megadrop-banibs.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://megadrop-banibs.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://megadrop-banibs.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
