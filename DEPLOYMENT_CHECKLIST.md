...
**Test basic endpoint:**
```bash
curl https://api-opportunities.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://api-opportunities.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://api-opportunities.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
