...
**Test basic endpoint:**
```bash
curl https://profile-express.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://profile-express.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://profile-express.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
