...
**Test basic endpoint:**
```bash
curl https://newsfix-dev.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://newsfix-dev.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://newsfix-dev.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
