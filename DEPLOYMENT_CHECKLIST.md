...
**Test basic endpoint:**
```bash
curl https://moodwatch-6.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://moodwatch-6.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://moodwatch-6.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
