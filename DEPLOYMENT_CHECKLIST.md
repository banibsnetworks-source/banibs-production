...
**Test basic endpoint:**
```bash
curl https://opshub-tasks.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://opshub-tasks.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://opshub-tasks.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
