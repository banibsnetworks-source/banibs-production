...
**Test basic endpoint:**
```bash
curl https://banibs-hub.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://banibs-hub.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://banibs-hub.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
