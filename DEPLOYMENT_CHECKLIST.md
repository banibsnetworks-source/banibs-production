...
**Test basic endpoint:**
```bash
curl https://reveal-library.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://reveal-library.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://reveal-library.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
