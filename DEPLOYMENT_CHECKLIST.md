...
**Test basic endpoint:**
```bash
curl https://messenger-polish.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://messenger-polish.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://messenger-polish.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
