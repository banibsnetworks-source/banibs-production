...
**Test basic endpoint:**
```bash
curl https://black-indigenous.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://black-indigenous.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://black-indigenous.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
