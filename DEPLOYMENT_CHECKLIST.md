...
**Test basic endpoint:**
```bash
curl https://news-analytics.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://news-analytics.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://news-analytics.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
