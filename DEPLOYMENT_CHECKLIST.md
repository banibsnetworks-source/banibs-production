...
**Test basic endpoint:**
```bash
curl https://bpoc-rollout.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://bpoc-rollout.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://bpoc-rollout.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
