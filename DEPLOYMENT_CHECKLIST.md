...
**Test basic endpoint:**
```bash
curl https://visualstory-49.preview.emergentagent.com/api/
...
```bash
# Open in browser:
https://visualstory-49.preview.emergentagent.com/docs
```
...
```bash
curl -X PATCH https://visualstory-49.preview.emergentagent.com/api/opportunities/{ID}/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
