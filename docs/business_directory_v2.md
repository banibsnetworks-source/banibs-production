...
### Base URL
```
https://news-hub-69.preview.emergentagent.com/api/business
```
...
**1. Get Directory:**
```bash
curl https://news-hub-69.preview.emergentagent.com/api/business/directory
```

**2. Get Categories:**
```bash
curl https://news-hub-69.preview.emergentagent.com/api/business/categories
```

**3. Create Listing (requires auth):**
```bash
curl -X POST https://news-hub-69.preview.emergentagent.com/api/business/directory \
