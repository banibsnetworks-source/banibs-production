...
### Base URL
```
https://news-trust-system.preview.emergentagent.com/api/business
```
...
**1. Get Directory:**
```bash
curl https://news-trust-system.preview.emergentagent.com/api/business/directory
```

**2. Get Categories:**
```bash
curl https://news-trust-system.preview.emergentagent.com/api/business/categories
```

**3. Create Listing (requires auth):**
```bash
curl -X POST https://news-trust-system.preview.emergentagent.com/api/business/directory \
