...
**Test:** `curl https://health-directory.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://health-directory.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://health-directory.preview.emergentagent.com/api/sentiment/recalculate`
