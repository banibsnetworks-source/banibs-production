...
**Test:** `curl https://bookvault-manager.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://bookvault-manager.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://bookvault-manager.preview.emergentagent.com/api/sentiment/recalculate`
