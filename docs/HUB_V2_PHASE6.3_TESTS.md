...
**Test:** `curl https://moodwatch-6.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://moodwatch-6.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://moodwatch-6.preview.emergentagent.com/api/sentiment/recalculate`
