...
**Test:** `curl https://coming-soon-fix.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://coming-soon-fix.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://coming-soon-fix.preview.emergentagent.com/api/sentiment/recalculate`
