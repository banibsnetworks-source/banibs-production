...
**Test:** `curl https://banibs-connect-1.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://banibs-connect-1.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://banibs-connect-1.preview.emergentagent.com/api/sentiment/recalculate`
