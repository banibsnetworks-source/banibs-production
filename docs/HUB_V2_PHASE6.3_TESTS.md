...
**Test:** `curl https://real-time-chat-2.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://real-time-chat-2.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://real-time-chat-2.preview.emergentagent.com/api/sentiment/recalculate`
