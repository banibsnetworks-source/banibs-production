...
**Test:** `curl https://founder-tools-3.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://founder-tools-3.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://founder-tools-3.preview.emergentagent.com/api/sentiment/recalculate`
