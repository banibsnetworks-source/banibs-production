...
**Test:** `curl https://theme-harmony-2.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://theme-harmony-2.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://theme-harmony-2.preview.emergentagent.com/api/sentiment/recalculate`
