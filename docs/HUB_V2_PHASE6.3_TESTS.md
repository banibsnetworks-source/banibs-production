...
**Test:** `curl https://a-series-preview.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://a-series-preview.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://a-series-preview.preview.emergentagent.com/api/sentiment/recalculate`
