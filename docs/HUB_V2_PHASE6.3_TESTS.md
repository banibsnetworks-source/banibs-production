...
**Test:** `curl https://founder-books.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://founder-books.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://founder-books.preview.emergentagent.com/api/sentiment/recalculate`
