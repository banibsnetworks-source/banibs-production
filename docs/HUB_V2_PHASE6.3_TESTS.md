...
**Test:** `curl https://themeverse-3.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://themeverse-3.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://themeverse-3.preview.emergentagent.com/api/sentiment/recalculate`
