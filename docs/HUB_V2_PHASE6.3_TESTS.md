...
**Test:** `curl https://frontend-update-5.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://frontend-update-5.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://frontend-update-5.preview.emergentagent.com/api/sentiment/recalculate`
