...
**Test:** `curl https://api-platform-5.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://api-platform-5.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://api-platform-5.preview.emergentagent.com/api/sentiment/recalculate`
