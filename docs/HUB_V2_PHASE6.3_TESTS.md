...
**Test:** `curl https://news-hub-69.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://news-hub-69.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://news-hub-69.preview.emergentagent.com/api/sentiment/recalculate`
