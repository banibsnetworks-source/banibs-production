...
**Test:** `curl https://currency-exchange-41.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://currency-exchange-41.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://currency-exchange-41.preview.emergentagent.com/api/sentiment/recalculate`
