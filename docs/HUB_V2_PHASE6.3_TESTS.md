...
**Test:** `curl https://chatflow-95.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://chatflow-95.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://chatflow-95.preview.emergentagent.com/api/sentiment/recalculate`
