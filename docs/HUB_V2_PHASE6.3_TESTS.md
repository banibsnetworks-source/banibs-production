...
**Test:** `curl https://content-hub-555.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://content-hub-555.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://content-hub-555.preview.emergentagent.com/api/sentiment/recalculate`
