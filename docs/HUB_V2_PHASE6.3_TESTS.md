...
**Test:** `curl https://modal-overlay-fix-1.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://modal-overlay-fix-1.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://modal-overlay-fix-1.preview.emergentagent.com/api/sentiment/recalculate`
