...
**Test:** `curl https://regionsmart.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://regionsmart.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://regionsmart.preview.emergentagent.com/api/sentiment/recalculate`
