...
**Test:** `curl https://community-fix-9.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://community-fix-9.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://community-fix-9.preview.emergentagent.com/api/sentiment/recalculate`
