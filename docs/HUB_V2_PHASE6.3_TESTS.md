...
**Test:** `curl https://socialux-2.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://socialux-2.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://socialux-2.preview.emergentagent.com/api/sentiment/recalculate`
