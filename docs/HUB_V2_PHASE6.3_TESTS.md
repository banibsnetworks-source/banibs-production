...
**Test:** `curl https://visualstory-49.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://visualstory-49.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://visualstory-49.preview.emergentagent.com/api/sentiment/recalculate`
