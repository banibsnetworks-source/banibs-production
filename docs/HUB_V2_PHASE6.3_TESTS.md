...
**Test:** `curl https://data-insights-hub-39.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://data-insights-hub-39.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://data-insights-hub-39.preview.emergentagent.com/api/sentiment/recalculate`
