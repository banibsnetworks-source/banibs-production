...
**Test:** `curl https://community-hub-217.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://community-hub-217.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://community-hub-217.preview.emergentagent.com/api/sentiment/recalculate`
