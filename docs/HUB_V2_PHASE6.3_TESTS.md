...
**Test:** `curl https://sms-otp-security.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://sms-otp-security.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://sms-otp-security.preview.emergentagent.com/api/sentiment/recalculate`
