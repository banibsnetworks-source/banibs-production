...
**Test:** `curl https://talent-exchange-16.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://talent-exchange-16.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://talent-exchange-16.preview.emergentagent.com/api/sentiment/recalculate`
