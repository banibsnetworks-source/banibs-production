...
**Test:** `curl https://infinite-circles-mvp.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://infinite-circles-mvp.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://infinite-circles-mvp.preview.emergentagent.com/api/sentiment/recalculate`
