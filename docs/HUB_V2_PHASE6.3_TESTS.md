...
**Test:** `curl https://hdos-analyze.preview.emergentagent.com/api/news/latest?limit=2`
...
**Test:** `curl https://hdos-analyze.preview.emergentagent.com/api/resources?limit=2`
...
**Test:** `curl -X POST https://hdos-analyze.preview.emergentagent.com/api/sentiment/recalculate`
