...
**Version:** 2.7.0  
**Base URL:** `https://identity-trust-hub.preview.emergentagent.com/api/opportunities`  
...
# Filter by type
curl "https://identity-trust-hub.preview.emergentagent.com/api/opportunities/?type=job"
```
...
**Example:**
```bash
curl -X PATCH https://identity-trust-hub.preview.emergentagent.com/api/opportunities/69000eca84474146f644cf18/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
...
- **Swagger UI:** [https://identity-trust-hub.preview.emergentagent.com/docs](https://identity-trust-hub.preview.emergentagent.com/docs)
- **ReDoc:** [https://identity-trust-hub.preview.emergentagent.com/redoc](https://identity-trust-hub.preview.emergentagent.com/redoc)
