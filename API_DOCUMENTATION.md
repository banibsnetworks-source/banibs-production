...
**Version:** 2.7.0  
**Base URL:** `https://message-hub-335.preview.emergentagent.com/api/opportunities`  
...
curl https://message-hub-335.preview.emergentagent.com/api/opportunities/

# Filter by type
curl "https://message-hub-335.preview.emergentagent.com/api/opportunities/?type=job"
```
...
**Example:**
```bash
curl https://message-hub-335.preview.emergentagent.com/api/opportunities/featured
```
...
**Example:**
```bash
curl -X POST https://message-hub-335.preview.emergentagent.com/api/opportunities/ \
...
**Example:**
```bash
curl https://message-hub-335.preview.emergentagent.com/api/opportunities/pending \
...
**Example:**
```bash
curl -X PATCH https://message-hub-335.preview.emergentagent.com/api/opportunities/69000eca84474146f644cf18/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
...
- **Swagger UI:** [https://message-hub-335.preview.emergentagent.com/docs](https://message-hub-335.preview.emergentagent.com/docs)
- **ReDoc:** [https://message-hub-335.preview.emergentagent.com/redoc](https://message-hub-335.preview.emergentagent.com/redoc)
