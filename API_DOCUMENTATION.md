...
**Version:** 2.7.0  
**Base URL:** `https://social-business-hub.preview.emergentagent.com/api/opportunities`  
...
curl https://social-business-hub.preview.emergentagent.com/api/opportunities/

# Filter by type
curl "https://social-business-hub.preview.emergentagent.com/api/opportunities/?type=job"
```
...
**Example:**
```bash
curl https://social-business-hub.preview.emergentagent.com/api/opportunities/featured
```
...
**Example:**
```bash
curl -X POST https://social-business-hub.preview.emergentagent.com/api/opportunities/ \
...
**Example:**
```bash
curl https://social-business-hub.preview.emergentagent.com/api/opportunities/pending \
...
**Example:**
```bash
curl -X PATCH https://social-business-hub.preview.emergentagent.com/api/opportunities/69000eca84474146f644cf18/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
...
- **Swagger UI:** [https://social-business-hub.preview.emergentagent.com/docs](https://social-business-hub.preview.emergentagent.com/docs)
- **ReDoc:** [https://social-business-hub.preview.emergentagent.com/redoc](https://social-business-hub.preview.emergentagent.com/redoc)
