...
**Version:** 2.7.0  
**Base URL:** `https://modal-overlay-fix-1.preview.emergentagent.com/api/opportunities`  
...
curl https://modal-overlay-fix-1.preview.emergentagent.com/api/opportunities/

# Filter by type
curl "https://modal-overlay-fix-1.preview.emergentagent.com/api/opportunities/?type=job"
```
...
**Example:**
```bash
curl https://modal-overlay-fix-1.preview.emergentagent.com/api/opportunities/featured
```
...
**Example:**
```bash
curl -X POST https://modal-overlay-fix-1.preview.emergentagent.com/api/opportunities/ \
...
**Example:**
```bash
curl https://modal-overlay-fix-1.preview.emergentagent.com/api/opportunities/pending \
...
**Example:**
```bash
curl -X PATCH https://modal-overlay-fix-1.preview.emergentagent.com/api/opportunities/69000eca84474146f644cf18/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
...
- **Swagger UI:** [https://modal-overlay-fix-1.preview.emergentagent.com/docs](https://modal-overlay-fix-1.preview.emergentagent.com/docs)
- **ReDoc:** [https://modal-overlay-fix-1.preview.emergentagent.com/redoc](https://modal-overlay-fix-1.preview.emergentagent.com/redoc)
