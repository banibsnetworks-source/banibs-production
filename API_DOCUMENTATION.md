...
**Version:** 2.7.0  
**Base URL:** `https://real-time-chat-2.preview.emergentagent.com/api/opportunities`  
...
# Filter by type
curl "https://real-time-chat-2.preview.emergentagent.com/api/opportunities/?type=job"
```
...
**Example:**
```bash
curl -X PATCH https://real-time-chat-2.preview.emergentagent.com/api/opportunities/69000eca84474146f644cf18/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
...
- **Swagger UI:** [https://real-time-chat-2.preview.emergentagent.com/docs](https://real-time-chat-2.preview.emergentagent.com/docs)
- **ReDoc:** [https://real-time-chat-2.preview.emergentagent.com/redoc](https://real-time-chat-2.preview.emergentagent.com/redoc)
