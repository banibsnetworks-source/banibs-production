...
**Version:** 2.7.0  
**Base URL:** `https://disabilitysupport.preview.emergentagent.com/api/opportunities`  
...
curl https://disabilitysupport.preview.emergentagent.com/api/opportunities/

# Filter by type
curl "https://disabilitysupport.preview.emergentagent.com/api/opportunities/?type=job"
```
...
**Example:**
```bash
curl https://disabilitysupport.preview.emergentagent.com/api/opportunities/featured
```
...
**Example:**
```bash
curl -X POST https://disabilitysupport.preview.emergentagent.com/api/opportunities/ \
...
**Example:**
```bash
curl https://disabilitysupport.preview.emergentagent.com/api/opportunities/pending \
...
**Example:**
```bash
curl -X PATCH https://disabilitysupport.preview.emergentagent.com/api/opportunities/69000eca84474146f644cf18/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
...
- **Swagger UI:** [https://disabilitysupport.preview.emergentagent.com/docs](https://disabilitysupport.preview.emergentagent.com/docs)
- **ReDoc:** [https://disabilitysupport.preview.emergentagent.com/redoc](https://disabilitysupport.preview.emergentagent.com/redoc)
...
REACT_APP_BACKEND_URL=https://disabilitysupport.preview.emergentagent.com
```
