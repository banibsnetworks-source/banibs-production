...
**Version:** 2.7.0  
**Base URL:** `https://community-fix-9.preview.emergentagent.com/api/opportunities`  
...
curl https://community-fix-9.preview.emergentagent.com/api/opportunities/

# Filter by type
curl "https://community-fix-9.preview.emergentagent.com/api/opportunities/?type=job"
```
...
**Example:**
```bash
curl https://community-fix-9.preview.emergentagent.com/api/opportunities/featured
```
...
**Example:**
```bash
curl -X POST https://community-fix-9.preview.emergentagent.com/api/opportunities/ \
...
**Example:**
```bash
curl https://community-fix-9.preview.emergentagent.com/api/opportunities/pending \
...
**Example:**
```bash
curl -X PATCH https://community-fix-9.preview.emergentagent.com/api/opportunities/69000eca84474146f644cf18/approve \
  -H "X-API-Key: BANIBS_INTERNAL_KEY"
```
...
- **Swagger UI:** [https://community-fix-9.preview.emergentagent.com/docs](https://community-fix-9.preview.emergentagent.com/docs)
- **ReDoc:** [https://community-fix-9.preview.emergentagent.com/redoc](https://community-fix-9.preview.emergentagent.com/redoc)
