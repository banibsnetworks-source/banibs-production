...
async def create_campaign(
    ...
    # Campaign already has both _id and id fields from construction above
    return campaign
...
@router.patch("/campaigns/{campaign_id}", response_model=HelpingHandsCampaign, response_model_by_alias=False)
