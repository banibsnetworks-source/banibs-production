...
### Test Environment
- **URL**: https://visualstory-49.preview.emergentagent.com
...
2. Navigate to: `https://visualstory-49.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://visualstory-49.preview.emergentagent.com/api/bcee/update-region
   Headers:
