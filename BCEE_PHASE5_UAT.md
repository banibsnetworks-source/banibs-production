...
### Test Environment
- **URL**: https://identity-trust-hub.preview.emergentagent.com
...
2. Navigate to: `https://identity-trust-hub.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://identity-trust-hub.preview.emergentagent.com/api/bcee/update-region
   Headers:
