...
### Test Environment
- **URL**: https://banibs-platform.preview.emergentagent.com
...
2. Navigate to: `https://banibs-platform.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://banibs-platform.preview.emergentagent.com/api/bcee/update-region
   Headers:
