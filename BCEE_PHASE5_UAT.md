...
### Test Environment
- **URL**: https://banibs-launcher.preview.emergentagent.com
...
2. Navigate to: `https://banibs-launcher.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://banibs-launcher.preview.emergentagent.com/api/bcee/update-region
   Headers:
