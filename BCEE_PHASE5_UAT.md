...
### Test Environment
- **URL**: https://cultural-pulse-2.preview.emergentagent.com
...
2. Navigate to: `https://cultural-pulse-2.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://cultural-pulse-2.preview.emergentagent.com/api/bcee/update-region
   Headers:
