...
### Test Environment
- **URL**: https://calm-tech-learn.preview.emergentagent.com
...
2. Navigate to: `https://calm-tech-learn.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://calm-tech-learn.preview.emergentagent.com/api/bcee/update-region
   Headers:
