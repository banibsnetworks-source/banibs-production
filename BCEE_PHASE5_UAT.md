...
### Test Environment
- **URL**: https://socialux-2.preview.emergentagent.com
...
2. Navigate to: `https://socialux-2.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://socialux-2.preview.emergentagent.com/api/bcee/update-region
   Headers:
