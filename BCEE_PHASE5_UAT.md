...
### Test Environment
- **URL**: https://founder-books.preview.emergentagent.com
...
2. Navigate to: `https://founder-books.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://founder-books.preview.emergentagent.com/api/bcee/update-region
   Headers:
