...
2. Navigate to: `https://infinite-circles-mvp.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://infinite-circles-mvp.preview.emergentagent.com/api/bcee/update-region
   Headers:
