...
### Test Environment
- **URL**: https://hdos-analyze.preview.emergentagent.com
...
2. Navigate to: `https://hdos-analyze.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://hdos-analyze.preview.emergentagent.com/api/bcee/update-region
   Headers:
