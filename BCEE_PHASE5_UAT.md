...
### Test Environment
- **URL**: https://coming-soon-fix.preview.emergentagent.com
...
2. Navigate to: `https://coming-soon-fix.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://coming-soon-fix.preview.emergentagent.com/api/bcee/update-region
   Headers:
