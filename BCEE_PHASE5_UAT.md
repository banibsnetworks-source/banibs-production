...
### Test Environment
- **URL**: https://sms-otp-security.preview.emergentagent.com
...
2. Navigate to: `https://sms-otp-security.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://sms-otp-security.preview.emergentagent.com/api/bcee/update-region
   Headers:
