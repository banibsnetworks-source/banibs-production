...
### Test Environment
- **URL**: https://black-central.preview.emergentagent.com
...
2. Navigate to: `https://black-central.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://black-central.preview.emergentagent.com/api/bcee/update-region
   Headers:
