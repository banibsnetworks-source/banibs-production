...
### Test Environment
- **URL**: https://news-hub-69.preview.emergentagent.com
...
2. Navigate to: `https://news-hub-69.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://news-hub-69.preview.emergentagent.com/api/bcee/update-region
   Headers:
