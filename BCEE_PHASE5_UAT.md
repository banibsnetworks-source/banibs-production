...
### Test Environment
- **URL**: https://newsfix-dev.preview.emergentagent.com
...
2. Navigate to: `https://newsfix-dev.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://newsfix-dev.preview.emergentagent.com/api/bcee/update-region
   Headers:
