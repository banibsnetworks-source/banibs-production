...
### Test Environment
- **URL**: https://community-pulse-85.preview.emergentagent.com
...
2. Navigate to: `https://community-pulse-85.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://community-pulse-85.preview.emergentagent.com/api/bcee/update-region
   Headers:
