...
### Test Environment
- **URL**: https://news-trust-system.preview.emergentagent.com
...
2. Navigate to: `https://news-trust-system.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://news-trust-system.preview.emergentagent.com/api/bcee/update-region
   Headers:
