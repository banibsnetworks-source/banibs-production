...
### Test Environment
- **URL**: https://bookvault-manager.preview.emergentagent.com
...
2. Navigate to: `https://bookvault-manager.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://bookvault-manager.preview.emergentagent.com/api/bcee/update-region
   Headers:
