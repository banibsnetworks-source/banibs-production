...
### Test Environment
- **URL**: https://peoplerooms.preview.emergentagent.com
...
2. Navigate to: `https://peoplerooms.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://peoplerooms.preview.emergentagent.com/api/bcee/update-region
   Headers:
