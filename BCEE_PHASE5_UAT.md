...
### Test Environment
- **URL**: https://data-insights-hub-39.preview.emergentagent.com
...
2. Navigate to: `https://data-insights-hub-39.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://data-insights-hub-39.preview.emergentagent.com/api/bcee/update-region
   Headers:
