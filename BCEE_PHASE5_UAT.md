...
### Test Environment
- **URL**: https://founder-tools-3.preview.emergentagent.com
...
2. Navigate to: `https://founder-tools-3.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://founder-tools-3.preview.emergentagent.com/api/bcee/update-region
   Headers:
