...
### Test Environment
- **URL**: https://megadrop-banibs.preview.emergentagent.com
...
2. Navigate to: `https://megadrop-banibs.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://megadrop-banibs.preview.emergentagent.com/api/bcee/update-region
   Headers:
