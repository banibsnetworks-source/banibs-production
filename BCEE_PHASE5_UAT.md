...
### Test Environment
- **URL**: https://opshub-tasks.preview.emergentagent.com
...
2. Navigate to: `https://opshub-tasks.preview.emergentagent.com/portal/marketplace`
...
3. Use Postman or curl to call:
   ```bash
   POST https://opshub-tasks.preview.emergentagent.com/api/bcee/update-region
   Headers:
